...
namespace CodeSearcher.Tests.IntegrationTests
{
    ...
    public class CmdLineHandlerTests {
        ...
        {
            CmdLineHandler sut = new CmdLineHandler();
            var result = sut.Parse(new string[] {"-m=index", " --ip=.", "--sp=." });
            Assert.True(result);
        ...
        public void The_CommandLineHandler_Recognized_Mode_Search()
        {
            ...
            var result = sut.Parse(new string[] {"-m=search" , "--sw=bla", "-fe=xml", "--ip=."});
 ...
 [Test]
        ...
        {
            CmdLineHandler sut = new CmdLineHandler();
            var result = sut.Parse(new string[] {"-m=i" });
        ...
        {
            CmdLineHandler sut = new CmdLineHandler();
            var result = sut.Parse(new string[] {"-m=search" });
        ...
        {
            CmdLineHandler sut = new CmdLineHandler();
            var result = sut.Parse(new string[] {"-m=bla" });
            Assert.False(result);
        }
